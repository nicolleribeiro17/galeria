...
A idéia é ter um serviço GALERIA, o qual identifica no conjunto total de fotos onde o usuário é tagueado, aquelas mais
curtidas. 
Deve-se evitar fotos não tão pessoais, como aquelas onde o usuário é "mais um". 
Uma boa forma de evitar isso é limitar  o número total de taguados a um valor máximo (MAX_TAG) no total de fotos 
selecionadas para a GALERIA.
"""
...
max_tagueadas = 30 #limitar a 30 pessoas tagueadas no total das fotos, com isso se evita fotos com muitas pessoas
